...
public class ApprovalsExtensionTest {
    ...
    @Disabled("Un-ignore to see no approval in IDE")
    @Test
    public void see_how_my_IDE_reports_no_approval(Approver approver) throws IOException {
        whenApprovedIs(null, approver);
        approver.assertApproved("Deliberate failure - Jackdaws peck my big sphincter of quartz");
    }

    @Disabled("Un-ignore to see failure report in IDE")
    @Test
    public void see_how_my_IDE_reports_diffs(Approver approver) throws IOException {
